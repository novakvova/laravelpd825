...
@section('content')
    <div class="d-flex">
        <div
            style="flex-direction: row;color: white;position: absolute;align-self: center;display: flex;align-items: center;"
            class="ml-5">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                @else
                    <div>
                        <a style="margin: 19px;" href="{{ route('products.create')}}" class="btn btn-primary">Додати
                            продукт</a>
                    </div>
                @endguest
                <div class="container">
...
{{--                                           class="btn btn-primary">Edit</a>--}}
                ...
                <div>
                    <div class="col-sm-12">
                        ...
                        @else
                            <div>
                                <a style="margin: 19px;" href="{{ route('news.create')}}" class="btn btn-primary">Додати
                                    новину</a>
                            </div>
                        @endguest
                        <div class="container">
