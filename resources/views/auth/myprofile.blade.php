    ...
    <div class="row my-2">
        <div class="col-lg-8 order-lg-2">
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a href="" data-target="#messages" data-toggle="tab" class="nav-link">Change info</a>
                </li>
                <!-- <li class="nav-item">
                ...
                <div class="tab-pane active" id="profile">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p>
                                <h6><span class="badge badge-dark badge-pill">Date of birth:</span> 30/06/1999</h6>
                            </p>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="tab-pane" id="messages">
                    <form method="post" action="/profile/change">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" type="password" value="{{$user->epassword}}">
                            </div>
                        </div>

                        <button type='submit' class="btn btn-dark offset-9">Save</button>
                    </form>
                </div>
